-- V3: Add traceparent column to outbox_event for W3C trace context propagation.
--
-- The W3C traceparent string (format: 00-<32-hex-traceId>-<16-hex-spanId>-<2-hex-flags>)
-- is written by account-service's TransferService at the point the outbox row is created.
...
-- Ledger-service reads that header to reconstruct the remote SpanContext and create a
